...
object Escaping {
    ...
    fun indexOfCommentEscapeSequences(s: String) = s.indexOfAny(listOf(SLASH_STAR_ESCAPE, STAR_SLASH_ESCAPE))
    ...
    /** See [escapeKDoc]. */
    fun unescapeKDoc(s: String): String = s.replace(SLASH_STAR_ESCAPE, "/*").replace(STAR_SLASH_ESCAPE, "*/")
}
